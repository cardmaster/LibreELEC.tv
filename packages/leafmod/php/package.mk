...
makeinstall_target() {
    echo -n 'Install PHP in directory ' 
    pwd
    echo + cp $ROOT/$PKG_BUILD/.$TARGET_NAME/sapi/cgi/php-cgi $INSTALL/usr/bin/php-cgi
    mkdir -p $INSTALL/usr/bin
    cp $ROOT/$PKG_BUILD/.$TARGET_NAME/sapi/cgi/php-cgi $INSTALL/usr/bin/php-cgi
}
